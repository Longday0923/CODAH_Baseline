...
DATASET_LIST = ['csqa', 'obqa', 'socialiqa', 'codah']
...
def add_data_arguments(parser):
    ...
    # dataset specific
    parser.add_argument('-ds', '--dataset', default='codah', choices=DATASET_LIST, help='dataset name')
    ...
    parser.add_argument('--fold', default=0, type=int, choices=[0,1,2,3,4], help='Different splits for codah')
    # statements
    parser.add_argument('--train_statements', default='./data/{dataset}/fold_{fold}/statement/train.statement.jsonl')
    parser.add_argument('--dev_statements', default='./data/{dataset}/fold_{fold}/statement/dev.statement.jsonl')
    parser.add_argument('--test_statements', default='./data/{dataset}/fold_{fold}/statement/test.statement.jsonl')
    # preprocessing options
    parser.add_argument('-sl', '--max_seq_len', default=90, type=int)
